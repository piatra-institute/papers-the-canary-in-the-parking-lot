...
To check that this result does not depend on one emission factor, the calculation was repeated for 1482 combinations of round-trip length from 2 to 30 kilometres and emissions from 0.05 to 0.30 kilograms per kilometre. The reduction never exceeds 0.0377 and never falls below 0.00906. The site's own burden would have to be 21.8 times the stipulated value for it to account for half the burden of a meal occasion.
